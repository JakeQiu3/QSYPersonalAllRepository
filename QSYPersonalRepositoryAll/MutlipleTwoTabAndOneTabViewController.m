...
#warning 少 数据格式必须符合如下形式，才能正确执行。
    ...
    NSArray *testArray = @[
                           ...
                           @[ @{@"provinceName":@"台湾台湾台湾北京",@"citys":@[@"北京市",@"南沙市",@"广州市"]}, @{@"provinceName":@"河北",@"citys":@[@"山东",@"南沙市",@"广州市"]}, @{@"provinceName":@"商丘市",@"citys":@[@"商丘市",@"南沙市",@"广州市"]}],
                           @[@{@"provinceName":@"台湾台湾",@"citys":@[]},@{@"provinceName":@"山西",@"citys":@[]}] ];
    
    menu = [[QSMultiplePullDownMenu alloc] initWithArray:testArray selectedColor:[UIColor colorWithRed:150/255.0 green:205/255.0 blue:110/255.0 alpha:1.0f] constantTitlesArr:@[]];
