...
- (void)viewWillDisappear:(BOOL)animated{
    ...
    [UIView animateWithDuration:0.1 animations:^{
        ...
        self.overLay.alpha = 0;
        self.navigationController.navigationBar.barTintColor =  [UIColor colorWithRed:100/255.0 green:175/255.0 blue:247/255.0 alpha:1.0f];
    }];
}
