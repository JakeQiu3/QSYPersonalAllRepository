...
@property (strong, nonatomic) UIScrollView *sectionScrollView;//hang
@property (strong, nonatomic) UIScrollView *rowScrollView;//lie
...
//cell identifier dictionary： 存放的是以Identifier 为key，以cell为Value，以indextpath字典为value 的字典。
