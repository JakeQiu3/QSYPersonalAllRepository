...
@optional
- (void)bannerView:(KNBannerView *)bannerView  didSelectItemAtIndexPath:(NSInteger)index;
...
*/
+ (instancetype)bannerViewWithLocationImagesArr:(NSArray *)locationImgArr frame:(CGRect)frame placeHolder:(NSString *)placeHolder;
