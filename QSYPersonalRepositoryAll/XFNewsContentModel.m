...
- (instancetype)init {
    ...
    if (self) {
        ...
        paragrap10.className = @"paragrap10";
        ...
        paragrap11.className = @"paragrap11";
        ...
        paragrap12.className = @"paragrap12";
        ...
        paragrap13.className = @"paragrap13";
        ...
        paragrap14.className = @"paragrap14";
        ...
        paragrap15.className = @"paragrap15";
        ...
        paragrap16.className = @"paragrap16";
