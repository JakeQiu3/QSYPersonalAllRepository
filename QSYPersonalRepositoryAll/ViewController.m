...
- (void)loadData {
    _fileNameArray = @[@"知识点总测试",@"坐标系转换",@"下拉菜单",@"Xib和Storyboard使用汇总",@"Masonry 适配",@"Json和XML解析",@"数据库工具之FMDB",@"数据库工具之sqlite3.0",@"TabBar封装",@"二维码和条形码",@"计时器",@"导航条的隐藏和渐变处理",@"改变动画",@"冻结cell列表",@"加载Webview",@"加载WKWebview",@"TouchID使用",@"广告位轮播"].mutableCopy;
    _titileArray = @[@"TestTotalViewController",@"TapAExitOtherViewController",@"PullDownMenuViewController",@"AutoLayoutViewController",@"MasonryContraintViewController",@"JsonAndXmlParserViewController",@"FmdbViewController",@"SqliteDatabaseViewController",@"无",@"CaptureDeviceViewController",@"MZTLViewController",@"NavBarViewController",@"ChangeAnimationViewController",@"FreezeViewController",@"WebViewDemoViewController",@"WKWebViewDemoViewController",@"TouchIdViewController",@"BannerViewController"].mutableCopy;//
}
- (void)setUI {
